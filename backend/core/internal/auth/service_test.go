...
func userWithHashedPassword(t *testing.T, password string) *UserSummary {
	t.Helper()
...
func Test_reset_password_deve_atualizar_senha_com_token_valido(t *testing.T) {
	...
	repo.On("UpdateUserPassword", mock.Anything, mock.Anything).Return(nil)
	...
	require.NoError(t, err)
	repo.AssertCalled(t, "UpdateUserPassword", mock.Anything, mock.Anything)
}
...
func Test_reset_password_deve_rejeitar_mesma_senha(t *testing.T) {
	...
	repo.AssertNotCalled(t, "UpdateUserPassword")
}

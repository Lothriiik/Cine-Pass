...
func (m *MockSocialRepo) GetFollowers(ctx context.Context, userID uuid.UUID) ([]uuid.UUID, error) {
	args := m.Called(ctx, userID)
	return args.Get(0).([]uuid.UUID), args.Error(1)
}

func (m *MockSocialRepo) GetFollowing(ctx context.Context, userID uuid.UUID) ([]uuid.UUID, error) {
	args := m.Called(ctx, userID)
	return args.Get(0).([]uuid.UUID), args.Error(1)
}
...
func (m *MockUserProvider) GetUserByUsername(ctx context.Context, username string) (*UserSummary, error) {
...
func (m *MockUserProvider) GetUserByID(ctx context.Context, id uuid.UUID) (*UserSummary, error) {
